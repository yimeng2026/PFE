...
axiom InstantonModuliDimension {M G : Type*} [TopologicalSpace M] [Group G] [TopologicalSpace G]
  ...
  -- Atiyah-Singer index: requires elliptic operator theory on manifolds, axiomd as gauge theory axiom
...
axiom GaugeCouplingUnification :
  ...
  -- Gauge coupling unification at GUT scale: requires renormalization group analysis, axiomd
...
axiom ElectroweakSymmetryBreaking :
  ?(v : ?, v > 0 ?    -- Higgs VEV
    ...
    -- W boson: m_W = g₂v/2
    -- Z boson: m_Z = ?g₂?g₁?v/2
  -- Electroweak symmetry breaking: Higgs mechanism, axiomd as standard model axiom
