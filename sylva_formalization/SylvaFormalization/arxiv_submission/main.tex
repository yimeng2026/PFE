...
numbers on a stratified space.  While a complete first-principles derivation
of the layer weights $\mu_{k}$ remains open, the numerical consistency,
conceptual clarity, and falsifiable predictions make this a viable path toward
resolving the large-number puzzle.
