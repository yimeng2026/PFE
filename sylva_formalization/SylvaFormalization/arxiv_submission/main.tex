...
\subsection{Layer 1 $\to$ Layer 2: Continuum Limit}\label{subsec:continuum}
...
\texttt{BlochTheorem}, \texttt{BerryConnection}, \texttt{BerryCurvature},
\texttt{ChernNumber}) verifies each step of this derivation up to the
...
\subsection{Relation to the Muon $g-2$ Anomaly}\label{subsec:g2}
...
\begin{itemize}[noitemsep]
\item \textbf{Lean version:} 4.30.0 (via \texttt{lean-toolchain})
