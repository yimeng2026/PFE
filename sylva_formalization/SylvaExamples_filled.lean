...
-- 黎曼ζ函数前四个非平凡零点（数值近似）
def GAMMA_1 : ℝ := 14.134725141734693790457251983562470270784257115699
def GAMMA_2 : ℝ := 21.022039638771554992628479593896902777334340524903
def GAMMA_3 : ℝ := 25.010857580145688763213790992562821818659549672758
def GAMMA_4 : ℝ := 30.424876125859513210311897530584091320181560023715
